...
mkdir -p novaseq_small_hevs_all
proBASE_PATH=$BASE_PATH/novaseq_small_hevs_all
...
GENOME=/nesi/nobackup/vuw03607/mouse_rnaseq/h_indexed_genome_subread/Homo_sapiens.GRCh38.dna.primary_assembly
...
cutadapt -q 20 -a "TGGAATTCTCGGGTGCCAAGG;e=2.5" -u 4 -u -4 -m 14 -M 50 -o $trimmed_reads $fq > $proBASE_PATH/multiqc_trimmed/${base}.log
