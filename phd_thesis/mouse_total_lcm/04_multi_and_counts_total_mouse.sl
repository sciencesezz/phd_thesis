...
#This is a Bash Script for MultiQC and FeatureCounts for Mouse Total RNA Seq Analysis
...
#SBATCH --mem=16G
#SBATCH --output=/nesi/nobackup/vuw03607/novaseq_total_mlcm_04_%j.out
#SBATCH --error=/nesi/nobackup/vuw03607/novaseq_total_mlcm_04_%j.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=sarah.sczelecki@vuw.ac.nz

cd /nesi/nobackup/vuw03607/mouse_rnaseq/novaseq_total_mlcm_all

#set up required variables for script
BASE_PATH=/nesi/nobackup/vuw03607/mouse_rnaseq
proBASE_PATH=/nesi/nobackup/vuw03607/mouse_rnaseq/novaseq_total_mlcm_all
...
featureCounts -a $GENOME_GTF -o $proBASE_PATH/counts/novaseq_total_mlcm_all_counts.txt -T 2 -t exon -g gene_id $proBASE_PATH/hisat2_sorted/*.trimmed.sorted.bam
