...
#This is a Bash Script for MultiQC and FeatureCounts for Human Small RNA Seq Analysis
...
#SBATCH --mem=16G
#SBATCH --output=/nesi/nobackup/vuw03607/novaseq_small_hlcm_04_%j.out
#SBATCH --error=/nesi/nobackup/vuw03607/novaseq_small_hlcm_04_%j.err
#SBATCH --mail-type=ALL
#SBATCH --mail-user=sarah.sczelecki@vuw.ac.nz

cd /nesi/nobackup/vuw03607/mouse_rnaseq/novaseq_small_hlcm_all

#set up required variables for script
BASE_PATH=/nesi/nobackup/vuw03607/mouse_rnaseq
proBASE_PATH=/nesi/nobackup/vuw03607/mouse_rnaseq/novaseq_small_hlcm_all

MIRBASE_GTF=$BASE_PATH/mirbase_download/hsa.gff3
...
#counting of bam files
featureCounts -T 2 -t miRNA -g Name -O -s 1 -M -a $MIRBASE_GTF -o $proBASE_PATH/counts/novaseq_small_hlcm_counts.txt $proBASE_PATH/subread/*.bam
